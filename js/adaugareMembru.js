function isValid(nume, prenume, email, adresa, telefon,username,password) {
    ...
    if (username === "" || username.length<3) {
        toastr.error('Introduceți o valoare valida pentru username');
        return false;
    }
    if (password === "" || password.length<5) {
        toastr.error('Introduceți o valoare valida pentru parola de minim 6 caractere');
        return false;
    }else {
        return true;
    }
